...
abstract public class Stuff extends TJ {
	...
	Stuff(Type t, int l, boolean lv, boolean ia ){
		type = t; len = l; lvalue = lv; isArray = ia;
	}
...
//System.err.println("Stuff~42, isFcn: " + t + (t=='P') );
	...
	static Fvar createFvar(int cursor){ return new Fvar(cursor); }
...
class Sval extends Stuff {
	String val;
	Sval(String v){ super(Type.CHAR,v.length(),false,false); val=v; }
	public String toString(){ return val; }
	public String getStr(){ return val; }
	public Stuff klone(){ return new Sval(val); }
	public int getInt() { eset(TYPEERR); return -999999; }
}
class Cval extends Stuff {
	char val;
	Cval(char v, int len){ super(Type.CHAR,len,true,false); val=v; }
	Cval(int v) { super(Type.CHAR, 1, true, false); val=(char)v; }
	public String toString(){ return String.valueOf(val); }
	public Stuff klone(){ return new Cval(val); }
	public int getInt() {return (int)val;}
}
class Ival extends Stuff {
	int val;
	Ival(int v, int len){ super(Type.INT,len,true,false); val=v; }
	Ival(int v) { super(Type.INT, 1, true, false); val=v; }
	public String toString(){ return String.valueOf(val); }
	public Stuff klone(){ return new Ival(val); }
...
class Pval extends Stuff {
	int kursor;
	Pval(int v){ super(Type.INT,1,true,true); kursor=v; isArray=true; }
	public String toString(){ return String.valueOf(kursor); }
	public Stuff klone(){ return new Pval(kursor); }
	public int getInt(){return kursor;}
} 
// used only in var table, never pushed, no klone
class Fvar extends Stuff {
	int kursor;
	Fvar(int cursor){ super(Type.FCN,0,false,false); kursor=cursor; }
	String getStr(){ return String.valueOf(kursor); }
	public Stuff klone(){ return null; }
	public int getInt() { return kursor; }
}
